...
//base branca
  ...
  bntcorbotoesbranco.addEventListener('click', function(e){
    document.querySelector('.costas4').style.visibility = "visible";
  ...
  btncorbotoesazul.addEventListener('click', function(e){
    ...
    document.querySelector('.costas5').style.visibility = "visible";
    document.querySelector('.costas6').style.visibility = "hidden";
    document.querySelector('.frente7').style.visibility = "hidden";
    document.querySelector('.costas7').style.visibility = "hidden";
    document.querySelector('.frente8').style.visibility = "hidden";
  ...
  btncorbotoesvermelha.addEventListener('click', function(e){
    ...
    document.querySelector('.frente6').style.visibility = "hidden";
    document.querySelector('.costas5').style.visibility = "hidden";
    document.querySelector('.costas6').style.visibility = "visible";
  ...
  btncorbotoesamarela.addEventListener('click', function(e){
    ...
    document.querySelector('.costas6').style.visibility = "hidden";
    document.querySelector('.frente7').style.visibility = "hidden";
    document.querySelector('.costas7').style.visibility = "visible";
    document.querySelector('.frente8').style.visibility = "visible";
    document.querySelector('.costas8').style.visibility = "hidden";
    document.querySelector('.frente9').style.visibility = "hidden";
    document.querySelector('.costas9').style.visibility = "hidden";
    document.querySelector('.frente10').style.visibility = "hidden";
...
//punho branca
  ...
  btncorpunhoazul.addEventListener('click', function(e){
    document.getElementById('punho2').style.fill = "blue";
    document.getElementById('punho1').style.fill = "blue";
  ...
  btncorpunhovermelha.addEventListener('click', function(e){
    document.getElementById('punho2').style.fill = "red";
    document.getElementById('punho1').style.fill = "red";
  ...
  btncorpunhoamarela.addEventListener('click', function(e){
    document.getElementById('punho2').style.fill = "yellow";
    document.getElementById('punho1').style.fill = "yellow";
  ...
  btncorpunhoverde.addEventListener('click', function(e){
    document.getElementById('punho2').style.fill = "green";
    document.getElementById('punho1').style.fill = "green";
  ...
  btncorvistaEazul.addEventListener('click', function(e){
    document.getElementById('manga').style.fill = "blue";
    document.getElementById('manga1').style.fill = "blue";
  ...
  btncorvistaEvermelha.addEventListener('click', function(e){
    document.getElementById('manga').style.fill = "red";
    document.getElementById('manga1').style.fill = "red";
  ...
  btncorvistaEamarela.addEventListener('click', function(e){
    document.getElementById('manga').style.fill = "yellow";
    document.getElementById('manga1').style.fill = "yellow";
  ...
  btncorvistaEverde.addEventListener('click', function(e){
    document.getElementById('manga').style.fill = "green";
    document.getElementById('manga1').style.fill = "green";
